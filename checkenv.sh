...
declare -a vars=(AWS_ACCOUNT_ID TARGET_REGION \
  TASK_LIST_APPS_BUCKET TASK_LIST_PREPROCESS_DATA_BUCKET \
  TASK_LIST_LOG_DATA_BUCKET TASK_LIST_RESULT_DATA_BUCKET \
  ...
  TASK_LIST_DOMAIN TASK_LIST_COGNITO_DOMAIN_BASE)
