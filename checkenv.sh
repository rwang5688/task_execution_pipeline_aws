...
declare -a vars=(AWS_ACCOUNT_ID
  ...
  TASK_EXEC_UPLOAD_TASK_ISSUES_QUEUE \
  TASK_EXEC_GENERATE_TASK_SUMMARY_QUEUE \
  TASK_EXEC_TASK_TABLE \
  TASK_EXEC_ISSUE_TABLE \
  TASK_LIST_APPS_BUCKET \
  TASK_LIST_DOMAIN \
  TASK_LIST_COGNITO_DOMAIN_BASE)
